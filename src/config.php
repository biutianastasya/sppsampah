...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'l8Xqmb876YzuGulr', // Random key for encryption
    "ENCRYPTION_KEY" => '', // Encryption key for data protection
    "PROJECT_STYLESHEET_FILENAME" => "css/sppsampah.css", // Project stylesheet file name
    ...
    "ADMIN_USER_NAME" => "sementara", // Administrator user name
    "ADMIN_PASSWORD" => "sementara", // Administrator password
