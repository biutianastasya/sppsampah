...
return [
    "Databases" => [
        "DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "34.101.101.140", "port" => "3306", "user" => "biuti", "password" => "biubiudotcom", "dbname" => "sppsampah-db"]
    ],
    "SMTP" => [
    ...
    "JWT" => [
        "SECRET_KEY" => "2vuE90ZV3cAG8mg7", // API Secret Key
