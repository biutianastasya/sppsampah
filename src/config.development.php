...
return [
    "Databases" => [
        "DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "35.219.11.167", "port" => "3306", "user" => "sppsampah-dbuser", "password" => "sppsampah-dbuserpassword", "dbname" => "sppsampah-db"]
    ],
    "SMTP" => [
    ...
    "JWT" => [
        "SECRET_KEY" => "aV2rM2r2a0DtK0VM", // API Secret Key
