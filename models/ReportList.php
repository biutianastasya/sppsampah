...
class ReportList extends Report
{
    ...
    public function run()
    {
        ...
        $this->tanggal_laporan->setVisibility();
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->tanggal_laporan->AdvancedSearch->toJson(), ","); // Field tanggal_laporan
    ...
    protected function restoreFilterList()
    {
        ...
        // Field tanggal_laporan
        $this->tanggal_laporan->AdvancedSearch->SearchValue = @$filter["x_tanggal_laporan"];
        $this->tanggal_laporan->AdvancedSearch->SearchOperator = @$filter["z_tanggal_laporan"];
        $this->tanggal_laporan->AdvancedSearch->SearchCondition = @$filter["v_tanggal_laporan"];
        $this->tanggal_laporan->AdvancedSearch->SearchValue2 = @$filter["y_tanggal_laporan"];
        $this->tanggal_laporan->AdvancedSearch->SearchOperator2 = @$filter["w_tanggal_laporan"];
        $this->tanggal_laporan->AdvancedSearch->save();
    }
    ...
    protected function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->lokasi, $default, false); // lokasi
        $this->buildSearchSql($where, $this->tanggal_laporan, $default, false); // tanggal_laporan
        ...
        if (!$default && $this->Command == "search") {
            ...
            $this->tanggal_laporan->AdvancedSearch->save(); // tanggal_laporan
        }
        return $where;
    }
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->tanggal_laporan->AdvancedSearch->issetSession()) {
            return true;
        }
        return false;
    }
    ...
    protected function resetAdvancedSearchParms()
    {
                ...
                $this->tanggal_laporan->AdvancedSearch->unsetSession();
    }
    ...
    protected function restoreSearchParms()
    {
        ...
        // Restore advanced search values
                ...
                $this->tanggal_laporan->AdvancedSearch->load();
    }
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->gambar_terlapor); // gambar_terlapor
            $this->updateSort($this->gambar_terproses); // gambar_terproses
            $this->updateSort($this->status_id); // status_id
            $this->updateSort($this->keterangan); // keterangan
            $this->updateSort($this->tanggal_laporan); // tanggal_laporan
            $this->updateSort($this->tanggal_diproses); // tanggal_diproses
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->id->setSort("");
                $this->lokasi->setSort("");
                $this->gambar_terlapor->setSort("");
                $this->gambar_terproses->setSort("");
                $this->status_id->setSort("");
                $this->keterangan->setSort("");
                $this->tanggal_laporan->setSort("");
                $this->tanggal_diproses->setSort("");
            }
    ...
    protected function loadSearchValues()
    {
        ...
        // lokasi
        if (!$this->isAddOrEdit() && $this->lokasi->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->lokasi->AdvancedSearch->SearchValue != "" || $this->lokasi->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // tanggal_laporan
        if (!$this->isAddOrEdit() && $this->tanggal_laporan->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->tanggal_laporan->AdvancedSearch->SearchValue != "" || $this->tanggal_laporan->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        return $hasValue;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($this->gambar_terlapor->UseColorbox) {
                ...
                $this->gambar_terlapor->LinkAttrs["data-rel"] = "report_x" . $this->RowCount . "_gambar_terlapor";
            ...
            if ($this->gambar_terproses->UseColorbox) {
                ...
                $this->gambar_terproses->LinkAttrs["data-rel"] = "report_x" . $this->RowCount . "_gambar_terproses";
    ...
    protected function setupSearchOptions()
    {
        ...
        if (IsMobile()) {
            $item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"reportsearch\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
        } else {
            $item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-table=\"report\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,btn:'SearchBtn',url:'reportsearch'});\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
        }
        $item->Visible = true;
