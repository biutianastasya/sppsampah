...
class ReportSearch extends Report
{
    ...
    // Page object name
    public $PageObjName = "ReportSearch";
    ...
    {
        $srchUrl = "";
        $this->buildSearchUrl($srchUrl, $this->lokasi); // lokasi
        $this->buildSearchUrl($srchUrl, $this->tanggal_laporan); // tanggal_laporan
        if ($srchUrl != "") {
            $srchUrl .= "&";
        }
        $srchUrl .= "cmd=search";
    ...
    protected function loadSearchValues()
    {
        // Load search values
        $hasValue = false;
        if ($this->lokasi->AdvancedSearch->post()) {
            $hasValue = true;
        }
        if ($this->tanggal_laporan->AdvancedSearch->post()) {
            $hasValue = true;
        }
        return $hasValue;
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->lokasi->EditValue = HtmlEncode($this->lokasi->AdvancedSearch->SearchValue);
            ...
            $this->tanggal_laporan->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->tanggal_laporan->AdvancedSearch->SearchValue, 1), 8));
    ...
    protected function validateSearch()
    {
        ...
        if (!CheckDate($this->tanggal_laporan->AdvancedSearch->SearchValue)) {
            $this->tanggal_laporan->addErrorMessage($this->tanggal_laporan->getErrorMessage(false));
        }
